...
\begin{document}
  ...
  { 
    ...
    \centering
    \includegraphics[width=10cm,height=6cm]{datacube.pdf}
    \end{frame}
  }
  ...
  { 
    ...
    \begin{tikzpicture}[scale=0.75]
      ...
      \node at (-7,0) (time) {Time};
      \node[draw, circle, fill=black, label=below:{\texttt{ANNUALY}}] at (-4.5,0) (annualy) {};
      \node[draw, circle, fill=black, label=below:{\texttt{QTRL}}] at (-3,0) (qtrl) {};
      \node[draw, circle, fill=black, label=below:{\texttt{DAILY}}] at (-1.5,0) (daily) {};

      \node[draw, circle, fill=black] at (0,0) (c) {};

      \node[draw, circle, fill=black, label=below:{\texttt{PRODUCT ITEM}}] at (1.5,0) (productitem) {};
      \node[draw, circle, fill=black, label=above:{\texttt{PRODUCT LINE}}] at (3,0) (productline) {};
      \node[draw, circle, fill=black, label=below:{\texttt{PRODUCT GROUP}}] at (4.5,0) (productgroup) {};
      \node at (7,0) (product) {Product};

      \node[draw, circle, fill=black] at (1.5,1.5) (dot4) {};
      \node at (3,3) (customer) {Customer};

      \node[draw, circle, fill=black, label=below:{\texttt{TRUCK}}] at (-1.5,1.5) (truck) {};
      \node[draw, circle, fill=black, label=below:{\texttt{AIR-EXPRESS}}] at (-2.5,2.5) (airexpress) {};
      \node at (-3.5,3.5) (shippingmethod) {Shipping method};


      \node[draw, circle, fill=black, label=below:{\texttt{CITY}}] at (-1.5,-1.5) (city) {};
      \node[draw, circle, fill=black, label=below:{\texttt{COUNTRY}}] at (-2.5,-2.5) (country) {};
      \node[draw, circle, fill=black, label=below:{\texttt{REGION}}] at (-3.5,-3.5) (region) {};
      \node at (-4.5,-4.5) (location) {Location};

      \node[draw, circle, fill=black, label=below:{\texttt{SALES PERSON}}] at (1.5,-1.5) (salesperson) {};
      \node[draw, circle, fill=black, label=below:{\texttt{DISTRICT}}] at (2.5,-2.5) (district) {};
      \node[draw, circle, fill=black, label=below:{\texttt{DIVISION}}] at (3.5,-3.5) (division) {};
      \node at (4.5,-4.5) (organization) {Organization};
  ...
  { 
    ...
    \begin{frame}{Indexing OLAP data: join indices}
        \begin{itemize}
            ...
            \begin{itemize}
              \item Materializes rel. join in JI file and speeds up relational join.
            \end{itemize}
  ...
  { 
    ...
    \begin{itemize}
      ...
      \begin{itemize}
        \item Use relational or extended-relational DBMS to store and manage warehouse data and OLAP middleware.
