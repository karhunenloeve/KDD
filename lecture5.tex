  ...
  { 
    ...
    \begin{frame}{What is a data warehouse?}
        \begin{itemize}
            ...
            \end{itemize}
            \item \textbf{Famous: "A data warehouse is a {\color{airforceblue}subject-oriented, integrated, time-variant, and nonvolatile} collection of data in support of management's decision-making process." -- W. H. Inmon.}
