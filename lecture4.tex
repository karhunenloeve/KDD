  ...
  { 
    ...
    \begin{itemize}
      ...
      \item \textbf{Pearson's correlation coefficient:}\\
            \begin{align}
              r = \frac{n \sum_{i=1}^{n}a_ib_i - \sum_{i=1}^{n}a_i \sum_{i=1}^{n}b_i}{\sqrt{\left(n \sum_{i=1}^{n} a^2 - \left(\sum_{i=1}^{n} a_i\right)^2\right) \left(n \sum_{i=1}^{n}b^2 - \left(\sum_{i=1}^{n}b_i\right)^2\right)}},
            \end{align}
