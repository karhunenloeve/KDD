...
\begin{document}
  ...
  { 
    ...
    \begin{itemize}
      ...
      \item \textbf{Inter quartile range:} {\color{blue}IQR} $=Q_3-Q-1$.
    ...
    \begin{center}
        ...
        \end{center}
          ...
          \begin{itemize}
            ...
            \item The ends of the box are at the first and third quartiles, i.e. the height of the box is IQR. The median is marked by a line within the box.
