...

{
 ...
 { 
  ...
  { 
    ...
    The data needs to be transformed into a (possibly artifical) two dimensional spatial representation which preserves some characteristics of data.\\[0.5cm]
    \centering
    \begin{tikzpicture}[yscale=1.75]
    \begin{axis}[
        domain=-2:2,
        domain y=0:2*pi,
    ]
  ...
  { 
    ...
    \begin{itemize}
      ...
      \begin{itemize}
        \item Replace $x_i$ by their rank $r_i \in \{1, \ldots, N \}$.
        \item Map the range of each variable onto $[0,1]$ by replacing $j$-th object in the $i$-th variable by
        \begin{align}
        z_{ji} = \frac{r_{ji}}{N-1}.
        \end{align}
